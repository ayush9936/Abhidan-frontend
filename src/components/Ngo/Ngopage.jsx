          ...
          <div className=" col-md-6  mt-2  border-2">
            <div className="ngo_content text-center mt-10 ">
              ...
              <p className="text-lg  text-center">
                ...
                coordination. By partnering with NGOs, social development
                projects can achieve a wider reach and create a sustainable
                impact.
              </p>
            </div>
          </div>
          ...
          <div className="row-next mt-2">
            ...
            <div className="ngo-card">
              ...
              <div className="ngo-details">
                ...
                <button
                  type="submit"
                  className=" px-3 py-1 text-lg rounded-md border-2 border-yellow-400   hover:bg-yellow-400 "
                >
                  {" "}
                  Donate
                </button>
